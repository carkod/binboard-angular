 ...
 */
export class CryptotableDataSource extends DataSource<Tracking> {
   ...
   */
  private getPagedData(data: Tracking[]) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: Tracking[]) {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort.active) {
        ...
        case 'changePercent': return compare(+a.changePercent, +b.changePercent, isAsc);
        default: return 0;
      }
    });
  }
